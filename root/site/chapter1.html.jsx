...
export default function(props) {
  return(
    <Layout compact={ true }>
      <a name="main"></a>
      <h1 id="why-this-book-exists">Chapter 1 - Why This Book Exists <small>(excerpt)</small></h1>
      ...
      <h2 id="what-is-sustainability-">1.2 What is Sustainability?</h2>
      ...
      <h2 id="why-care-about-sustainability-">1.3 Why Care About Sustainability?</h2>
      ...
      <h2 id="how-to-value-sustainability-">1.4 How to Value Sustainability?</h2>
      ...
      <aside class="sidebar">
        <h1>Understanding Growth at Stitch Fix</h1>
        <p>
      ...
      <h2 id="assumptions">1.5 Assumptions</h2>
      ...
      <h3 id="the-software-has-a-clear-purpose">1.5.1 The Software Has a Clear Purpose</h3>
      ...
      <h3 id="the-software-needs-to-exist-for-years">1.5.2 The Software Needs To Exist For Years</h3>
      ...
      <h3 id="the-software-will-evolve">1.5.3 The Software Will Evolve</h3>
      ...
      <h3 id="the-team-will-change">1.5.4 The Team Will Change</h3>
      ...
      <h3 id="you-value-sustainability-consistency-and-quality">1.5.5 You Value Sustainability, Consistency, and Quality</h3>
      ...
      <aside class="sidebar">
        <h1>Our Uneventful Migration to AWS</h1>
        <p>
      ...
      <h2 id="why-should-you-trust-me-">1.6 Why should you trust me?</h2>
      ...
      <footer>
        <h1>Join the Mailing List For Updates</h1>
        <EmailForm />
      </footer>
  </Layout>
  );
